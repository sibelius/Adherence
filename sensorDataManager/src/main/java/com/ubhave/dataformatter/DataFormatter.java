...
import com.ubhave.dataformatter.json.pull.GravityFormatter;
import com.ubhave.dataformatter.json.pull.GyroscopeFormatter;
import com.ubhave.dataformatter.json.pull.LinearAccelerationFormatter;
...
import edu.arizona.adherence.dataformatter.json.ZephyrFormatter;
...
public abstract class DataFormatter
{
	...
	public static JSONFormatter getJSONFormatter(final Context c, final int sensorType)
	{
        ...
        case SensorUtils.SENSOR_TYPE_GRAVITY: return new GravityFormatter(c);
        case SensorUtils.SENSOR_TYPE_LINEAR_ACCELERATION: return new LinearAccelerationFormatter(c);

        case SensorUtils.SENSOR_TYPE_ZEPHYR: return new ZephyrFormatter(c);
		default: return null;
		}
	}

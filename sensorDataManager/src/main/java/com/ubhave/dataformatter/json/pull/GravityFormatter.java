...
public class GravityFormatter extends PullSensorJSONFormatter
{
	...
	public GravityFormatter(final Context context)
	{
		super(context, SensorUtils.SENSOR_TYPE_GRAVITY);
	}

	@Override
	protected void addSensorSpecificData(JSONObject json, SensorData data) throws JSONException
	{
		GravityData gravityData = (GravityData) data;
		ArrayList<float[]> readings = gravityData.getSensorReadings();
		ArrayList<Long> timestamps = gravityData.getSensorReadingTimestamps();
	...
	public SensorData toSensorData(String jsonString)
	{
		...
		if (jsonData != null)
		{
			...
			try
			{
                GravityProcessor processor = (GravityProcessor) AbstractProcessor.getProcessor(applicationContext, sensorType, setRawData, setProcessedData);
